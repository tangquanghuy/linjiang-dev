...
export function characterPage(name) {
  ...
  return `
<section class="ppanel is-page pcharacter-page t-${girl.theme}" data-panel="page" role="dialog"
  aria-label="${girl.name} 完整档案">
  ${head(girl.romaji, `${girl.name} · 完整档案`)}
  <button class="pclose" type="button" data-page-close aria-label="返回">×</button>

  <div class="parc-id">
    <figure class="parc-art"><img src="${girl.art}" alt="" draggable="false" decoding="async"></figure>
